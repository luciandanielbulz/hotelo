                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    @if ($page == $paginator->currentPage())
                                        <li class="page-item active" wire:key="paginator-{{ $paginator->getPageName() }}-page-{{ $page }}" aria-current="page"><span class="page-link" style="font-weight: bold !important; text-decoration: underline !important; color: #007bff !important; font-size: 1.2em !important;">{{ $page }}</span></li>
                                    @else
