<x-layout>
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold text-gray-900">Archivierte Angebote</h1>
            <p class="mt-2 text-sm text-gray-700">Eine Liste aller archivierten Angebote in Ihrem Konto, inklusive Nummer, Datum, Kunde und Beschreibung.</p>
        </div>
    </div>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <form id="searchForm" class="form-inline flex w-1/3" method="GET" action="{{ route('offer.index_archivated') }}">
