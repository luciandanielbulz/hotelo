        ...
        <div class="hidden md:flex md:items-center md:justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('offer.index') }}" 
                   class="inline-flex items-center px-4 py-2 bg-white/70 backdrop-blur-sm text-gray-700 font-medium rounded-lg border border-gray-300 hover:bg-white/90 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300">
            ...
            <div class="md:hidden mb-4">
                ...
                <div class="mt-3 text-center">
                    <button @click="openCustomerModal = true"
                            class="inline-flex items-center px-4 py-2 bg-blue-900 text-white font-medium rounded-lg hover:bg-blue-800 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
