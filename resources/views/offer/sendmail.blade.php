<x-layout>
    <div class="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-5">
        <div class="px-4 sm:px-0">
            <h2 class="text-base font-semibold text-gray-900">Angebot per E-Mail versenden</h2>
            <p class="mt-1 text-sm text-gray-600">Senden Sie das Angebot an die gewünschte E-Mail-Adresse.</p>
        </div>

        <form method="post" action="{{ route('sendoffer.email') }}" id="emailForm" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-3">
            @csrf
            ...
            <div class="sm:col-span-1 md:col-span-1 px-6 pt-3 pb-6">
                ...
                <div class="mt-1">
                    <input type="text" id="subject" name="subject" value="" class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 sm:text-sm" required>
                </div>
            ...
            <div class="sm:col-span-6 md:col-span-3 px-6 pb-6">
                ...
                <div class="mt-1">
                    <textarea name="message" id="message" rows="20" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 focus:outline-indigo-600"></textarea>
                </div>
            </div>
