        ...
        <form action="{{ route('clients.store') }}" method="POST">
            ...
            <div class="form-row mt-4">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="vat_number" name="vat_number" value="{{ old('vat_number') }}" required>
                    @error('vat_number')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" id="tax_id" name="tax_id" required>
                        ...
                        @foreach ($taxrates as $taxrate)
                            <option value="{{ $taxrate->id }}" {{ old('tax_id') == 2 ? 'selected' : '' }}>
                                {{ $taxrate->taxrate }}%
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-row mt-4">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="webpage" name="webpage" value="{{ old('webpage') }}">
                    @error('webpage')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row mt-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="accountnumber" name="accountnumber" value="{{ old('accountnumber') }}" required>
                    @error('accountnumber')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="bic" name="bic" value="{{ old('bic') }}" required>
                    @error('bic')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row mt-4">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="smallbusiness" name="smallbusiness" required>
                        <option value="">Bitte wählen...</option>
                        <option value="1" {{ old('smallbusiness')}}>Ja</option>
                        <option value="0" {{ old('smallbusiness')}} selected>Nein</option>
                    </select>
                    @error('smallbusiness')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" id="signature" name="signature" rows="3">{{ old('signature') }}</textarea>
                    @error('signature')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row mt-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" id="logoheight" name="logoheight" value="{{ old('logoheight',100) }}">
                    @error('logoheight')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" id="logowidth" name="logowidth" value="{{ old('logowidth',100) }}">
                    @error('logowidth')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row mt-4">
                <div class="form-group col">
                    ...
                    <input type="number" class="form-control" id="lastoffer" name="lastoffer" value="{{ old('lastoffer',1) }}" required>
                    @error('lastoffer')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group col">
                    ...
                    <input type="number" class="form-control" id="offermultiplikator" name="offermultiplikator" value="{{ old('offermultiplikator', 10000) }}" required>
                ...
                <div class="form-group col">
                    ...
                    <input type="number" class="form-control" id="lastinvoice" name="lastinvoice" value="{{ old('lastinvoice',1) }}" required>
                    @error('lastinvoice')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group col">
                    ...
                    <input type="number" class="form-control" id="invoicemultiplikator" name="invoicemultiplikator" value="{{ old('invoicemultiplikator', 10000) }}" required>
            ...
            <div class="form-group mt-4">
                <button type="submit" class="btn btn-primary">Klient erstellen</button>
            </div>
        </form>
        <hr>
    </div>
