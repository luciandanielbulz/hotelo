                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="mt-1 text-lg font-mono text-indigo-600">{{ $clientSettings->generateInvoiceNumber() }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-700">Nächste Angebotsnummer:</dt>
                                <dd class="mt-1 text-lg font-mono text-indigo-600">{{ $clientSettings->generateOfferNumber() }}</dd>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if(auth()->user()->hasPermission('edit_client_settings'))
                    <div class="border-t border-gray-200 pt-6">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('client-settings.edit') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
