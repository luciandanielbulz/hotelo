        ...
        <form action="{{ route('logos.store') }}" method="POST" enctype="multipart/form-data" class="sm:col-span-1 md:col-span-3">
            ...
            <div class="grid md:grid-cols-2 sm:grid-cols-1 pb-4 gap-x-6">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input type="file" name="file" id="filename" required class="block w-full rounded-md bg-white px-3 py-2.5 text-base font-medium text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 shadow-md hover:shadow-lg transition-all duration-200">
