        ...
        <div class="sm:flex sm:items-center mt-4">
            <div class="sm:flex-auto">
                <form id="searchForm" class="form-inline flex w-1/3" method="GET" action="{{ route('outgoingemails.index') }}">
                    <input type="text" id="searchInput" name="search" class="form-control mr-2 rounded-md border-gray-300 px-3 py-2 text-sm w-full" placeholder="Suchen" value="{{ request('search') }}">
