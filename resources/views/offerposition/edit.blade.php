        ...
        <div class="bg-green-50/60 backdrop-blur-lg rounded-xl p-6 border border-green-200 ">
            ...
            <form method="POST" action="{{ route('offerposition.update', ['offerposition' => $offerpositioncontent->id]) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="details" id="details" rows="10" class="block w-full rounded-lg bg-white/70 backdrop-blur-sm px-4 py-3 text-base text-gray-900 border border-green-300 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 hover:shadow-lg transition-all duration-200" placeholder="Geben Sie den Beschreibungstext ein..." required>{{ $offerpositioncontent->details }}</textarea>
                </div>
