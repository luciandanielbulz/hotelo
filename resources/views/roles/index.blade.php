                                ...
                                <tr data-id="{{ $role->id }}" class="hover:bg-indigo-100 cursor-pointer">
                                    ...
                                    <td class="text-right px-3 py-4 text-sm sm:whitespace-nowrap">
                                        <div class="flex items-center justify-end gap-2">
                                            <button onclick="openCopyModal({{ $role->id }}, '{{ addslashes($role->name) }}', '{{ addslashes($role->description ?? '') }}')" class="hidden sm:inline-flex items-center justify-center rounded-md bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 px-2 sm:px-3 py-2 text-sm font-semibold text-white shadow-sm hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300" title="Kopieren">
            ...
            <div class="p-6">
                ...
                <form id="copyRoleForm" onsubmit="copyRole(event)">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="copyRoleName" name="name" required class="w-full rounded-lg border border-gray-300 px-4 py-2 text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-blue-900" placeholder="z.B. Rolle - Kopie">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="copyRoleDescription" name="description" rows="3" class="w-full rounded-lg border border-gray-300 px-4 py-2 text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-blue-900" placeholder="Beschreibung der neuen Rolle..."></textarea>
                    </div>
                    ...
                    <div class="flex gap-3">
                        <button type="submit" class="flex-1 px-6 py-3 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white font-semibold rounded-lg hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl">
                            Kopieren
                        </button>
