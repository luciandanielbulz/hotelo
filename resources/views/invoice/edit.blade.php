<x-layout>
        ...
        <div class="hidden md:flex md:items-center md:justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('invoice.index') }}" 
                   class="inline-flex items-center px-4 py-2 bg-white/70 backdrop-blur-sm text-gray-700 font-medium rounded-lg border border-gray-300 hover:bg-white/90 transition-all duration-300 hover:shadow-2xl hover:scale-105 active:scale-95">
                ...
                @if(auth()->user()->hasPermission('send_emails'))
                    <form action="{{ route('invoice.sendmail') }}" method="POST">
                        ...
                        <button type="submit"
                                class="inline-flex items-center px-6 py-2 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 text-white font-semibold rounded-lg hover:from-purple-500 hover:via-purple-400 hover:to-purple-500 transition-all duration-300 hover:shadow-2xl hover:scale-105 active:scale-95">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button onclick="window.open('{{ route('createinvoice.pdf', ['invoice_id' => $invoice->id]) }}', '_blank')"
                         class="inline-flex items-center px-6 py-2 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white font-semibold rounded-lg hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 transition-all duration-300 hover:shadow-2xl hover:scale-105 active:scale-95">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white/60 backdrop-blur-lg rounded-xl p-6 border border-stone-200 mb-6">
            ...
            <div class="md:hidden mb-4">
                ...
                <div class="mt-3 text-center">
                    <button @click="openCustomerModal = true"
                            class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white font-medium rounded-lg hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 transition-all duration-300 hover:shadow-2xl hover:scale-105 active:scale-95">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="hidden md:flex items-center justify-between mb-4">
                ...
                <button @click="openCustomerModal = true"
                            class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white font-medium rounded-lg hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                    </svg>
                    <span class="hidden lg:inline">Kunden ändern</span>
                ...
                <div class="bg-white rounded-lg flex flex-col"
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                        <div class="flex justify-end">
                            <button @click="openCustomerModal = false" 
                                    class="px-6 py-2 bg-gradient-to-r from-gray-600 via-gray-500 to-gray-600 text-white font-medium rounded-lg hover:from-gray-500 hover:via-gray-400 hover:to-gray-500 transition-all duration-300 hover:shadow-2xl hover:scale-105 active:scale-95">
        ...
        <div class="bg-white/60 backdrop-blur-lg rounded-xl p-6 border border-stone-200 mb-6">
            ...
            <livewire:invoice.invoicepositions-table :invoiceId="$invoice->id"/>
        </div>
    ...
    <div class="md:hidden fixed bottom-6 right-6 z-50 flex flex-col space-y-3">
        ...
        <form action="{{ route('invoice.sendmail') }}" method="POST">
            ...
            <input type="hidden" name="objecttype" value="invoice">
            <button type="submit"
                    class="flex items-center justify-center w-14 h-14 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 text-white rounded-full hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95"
                    title="Senden">
        ...
        <!-- Vorschau -->
        <button onclick="window.open('{{ route('createinvoice.pdf', ['invoice_id' => $invoice->id]) }}', '_blank')"
                class="flex items-center justify-center w-14 h-14 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white rounded-full hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 hover:from-blue-800 hover:via-blue-700 hover:to-blue-800"
                title="Vorschau">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
        ...
        <!-- Zurück -->
        <a href="{{ route('invoice.index') }}" 
           class="flex items-center justify-center w-12 h-12 bg-white/70 backdrop-blur-sm text-gray-700 rounded-full hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 border border-gray-300"
