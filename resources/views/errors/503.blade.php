        ...
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <div class="mx-auto h-20 w-20 bg-indigo-100 rounded-full flex items-center justify-center animate-float">
                    <svg class="h-10 w-10 text-blue-900 animate-pulse-slow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center">
                <button 
                    ...
                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-900 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 transition-colors duration-200"
                >
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
