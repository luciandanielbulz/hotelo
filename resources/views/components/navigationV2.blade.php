            ...
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="group flex items-center space-x-3">
                        <img src="{{ asset('logo/quickBill HauptLogo2.png') }}" alt="{{ config('app.name', 'quickBill') }}" class="h-24 w-24" style="height: 50px; width: 120px; margin-top: 2px;" />
                    </a>
                </div>
                ...
                <div class="hidden lg:ml-4 lg:flex lg:space-x-2">
                    ...
                    @if(auth()->user()->hasPermission('view_customers'))
                        <a href="{{ route('customer.index') }}" 
                           class="group relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-sm {{ request()->routeIs('customer.*') ? 'bg-blue-50 text-blue-700 shadow-sm border border-white/40' : 'text-gray-700 hover:text-gray-900' }}">
                    ...
                    @if(auth()->user()->hasPermission('view_offers'))
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                    class="group relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-sm {{ request()->routeIs('offer.*') ? 'bg-blue-50 text-blue-700 shadow-sm border border-white/40' : 'text-gray-700 hover:text-gray-900' }} flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(auth()->user()->hasPermission('view_invoices'))
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                    class="group relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-sm {{ request()->routeIs('invoice.*') ? 'bg-blue-50 text-blue-700 shadow-sm border border-white/40' : 'text-gray-700 hover:text-gray-900' }} flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                    ...
                    @if(auth()->user()->hasPermission('view_sales_analysis'))
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                    class="group relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-sm {{ request()->routeIs('sales.*') || request()->routeIs('bankdata.*') ? 'bg-blue-50 text-blue-700 shadow-sm border border-white/40' : 'text-gray-700 hover:text-gray-900' }} flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(auth()->user()->hasPermission('view_messages'))
                        <a href="{{ route('outgoingemails.index') }}" 
                           class="group relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-sm {{ request()->routeIs('outgoingemails.*') ? 'bg-blue-50 text-blue-700 shadow-sm border border-white/40' : 'text-gray-700 hover:text-gray-900' }}">
                            <div class="flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
