        ...
        <div class="sm:col-span-2 md:col-span-2">
            <form wire:submit.prevent="updateDepositAmount">
                ...
                <input type="number" wire:model="depositamount" step="0.01" min="0" id="depositamount"
                       class="mt-2 block w-full rounded-md bg-white px-3 py-2.5 text-base font-medium text-gray-900 border border-gray-300 placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:border-blue-900 shadow-md hover:shadow-lg transition-all duration-200 sm:text-sm">
                <button class="mt-4 inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 border border-transparent rounded-lg font-semibold text-sm text-white shadow-lg hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300">
                    Speichern
                </button>
            </form>
        </div>
