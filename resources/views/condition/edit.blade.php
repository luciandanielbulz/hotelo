            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-12">
                    <div class="sm:col-span-6">
                        <x-input name="conditionname" type="text" placeholder="Bedingungsname eingeben" label="Name der Bedingung" value="{{ old('conditionname', $condition->conditionname) }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all duration-300" required />
                    </div>
                </div>
            </div>
