    ...
    <div class="bg-white/60 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl">
        <form id="customer-edit-form" action="{{ route('customer.update', $customer->id) }}" method="POST" class="p-8">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-12">
                    <div class="sm:col-span-6">
                        <x-input name="address" type="text" placeholder="Adresse" label="Adresse" value="{{ $customer->address }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-12">
                    <div class="sm:col-span-2">
                        <x-input name="postalcode" type="text" placeholder="Postleitzahl" label="PLZ" value="{{ $customer->postalcode }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                    <div class="sm:col-span-4">
                        <x-input name="location" type="text" placeholder="Ort" label="Ort" value="{{ $customer->location }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-12">
                    <div class="sm:col-span-4">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-12">
                    <div class="sm:col-span-6">
                        <x-input name="email" type="email" placeholder="E-Mail" label="E-Mail" value="{{ $customer->email }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                    <div class="sm:col-span-3">
                        <x-input name="phone" type="text" placeholder="Telefonnummer" label="Telefon" value="{{ $customer->phone }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                    <div class="sm:col-span-3">
                        <x-input name="fax" type="text" placeholder="Fax" label="Fax" value="{{ $customer->fax }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        <x-input name="emailsubject" type="text" placeholder="E-Mail Betreff" label="E-Mail Betreff" value="{{ $customer->emailsubject }}" class="rounded-lg bg-white/70 backdrop-blur-sm border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300" />
                    </div>
                    <div>
                        ...
                        <textarea name="emailbody" id="emailbody" rows="8" class="block w-full rounded-lg bg-white/70 backdrop-blur-sm px-4 py-3 text-base text-gray-900 border-0 shadow-sm focus:ring-2 focus:ring-blue-700 transition-all duration-300 placeholder:text-gray-400">{{ old('email_body', $customer->emailbody) }}</textarea>
                    </div>
                </div>
            </div>
