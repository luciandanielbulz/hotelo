    ...
    <div class="space-y-10 divide-y divide-gray-900/10">
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-5">
            <div class="px-4 sm:px-0">
                <h2 class="text-base font-semibold text-gray-900">Neue Währung erstellen</h2>
                <p class="mt-1 text-sm text-gray-600">Fügen Sie eine neue Währung zum System hinzu.</p>
            </div>

            <form action="{{ route('currencies.store') }}" method="POST" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-3">
                @csrf
                ...
                <div class="px-4 py-6 sm:p-6">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="number" name="exchange_rate" id="exchange_rate" value="{{ old('exchange_rate', '1.0000') }}" 
                                       class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
                                       step="0.0001"
                                       min="0.0001"
                                       required>
